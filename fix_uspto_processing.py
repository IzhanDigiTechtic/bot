#!/usr/bin/env python3
"""
Comprehensive USPTO Data Processing Fix
This script will:
1. Clean up existing corrupted data
2. Fix configuration to process all products
3. Ensure proper data validation
4. Start fresh processing
"""
...
def cleanup_database():
    ...
    try:
        ...
        # Reset product registry (keep schema but reset processing status)
        cursor.execute("""
